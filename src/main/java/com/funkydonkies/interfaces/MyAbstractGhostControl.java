...
public abstract class MyAbstractGhostControl extends GhostControl {
	 ...
	 * 
	 * @param e
	 *            event the Spatial to destroy participates in
	 * @param toDestroyName
	 *            name of the Spatial to be destroyed
	 ...
	 * 
	 * @param s
	 *            spatial to disable controls on
	 */
	...
	/**
	 * Respawn the fish at a reachable location. TODO make sure its reachable
	 */
	public void respawn() {
